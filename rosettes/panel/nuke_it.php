...
<body>
	<div class="container">
		<center>
			...
			<?php if ($success) { ?>
				<p class="headingMd"><b>Gone, AND forgotten.</b></p>
			<?php } else { ?>
				<p class="headingMd"><b>Error.</b></p>
			<?php } ?>
		</center>
			<hr />
			<?php if ($success) { ?>
				<p>Rosettes no longer knows about your guild.</p>
			...
			<?php } else { ?>
				<p>It seems there was an error trying to forget your guild.</p>
